...
<p class="lead" style="margin-top: 0px" >Registro de Médicos</p> <hr class="my-1" >
<div  align="left" style="margin-bottom: 5px; margin-top: 0px;">
    <a role="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Agregar médico</a>
  </div>
  <!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-header">
          <h4 class="modal-title">Datos del Médico</h4>
        </div>
        ...
        <div class="modal-body">
                ...
                <input type="hidden" name="opc" id="opc" value="0">
                  ...
                  <label for="telefono">Tipo de sangre</label>
                  <div class="col-sm">
